		...
		<div class="main-slide owl-carousel owl-theme">
			<div class="item">
				<div class="slide-item">
					...
					<div class="image-slide">
						<img src="./assets/img/slides_examples/01.jpg" />
					</div>
				</div>
			</div>
			...
			<div class="item">
				<div class="slide-item">
					...
					<div class="image-slide">
						<img src="./assets/img/slides_examples/02.jpg" />
					</div>
				</div>
			</div>
			...
			<div class="item">
				<div class="slide-item">
					...
					<div class="image-slide">
						<img src="./assets/img/slides_examples/03.jpg" />
					</div>
				</div>
			</div>
		</div><!----main slide---->
					...
					<div class="content-hallfame-item">
						<a href="#">
							<div class="image-container">
								...
								<div class="image-box">
									<img src="./assets/img/fama/01.jpg" />
								</div>
							</div>
					...
					<div class="content-hallfame-item">
						<a href="#">
							<div class="image-container">
								...
								<div class="image-box">
									<img src="./assets/img/fama/02.jpg" />
								</div>
							</div>
							<div class="content-info">
								<h3>Nicolás Bustamante</h3>
					...
					<div class="content-hallfame-item">
						<a href="#">
							<div class="image-container">
								...
								<div class="image-box">
									<img src="./assets/img/fama/03.jpg" />
								</div>
							</div>
							<div class="content-info">
								<h3>Nicolás Bustamante</h3>
					...
					<div class="content-hallfame-item">
						<a href="#">
							<div class="image-container">
								...
								<div class="image-box">
									<img src="./assets/img/fama/04.jpg" />
								</div>
							</div>
							<div class="content-info">
								<h3>Nicolás Bustamante</h3>
					...
					<div class="content-hallfame-item">
						<a href="#">
							<div class="image-container">
								...
								<div class="image-box">
									<img src="./assets/img/fama/05.jpg" />
								</div>
							</div>
							<div class="content-info">
								<h3>Nicolás Bustamante</h3>
				...
				<div class="news-widget">
					<div class="last-new">
						...
						<div class="figure-img">
							...
							<img src="./assets/img/news/01.jpg" />
						</div>
						<div class="caption">
